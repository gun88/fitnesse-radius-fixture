...
@Component({
  selector: 'app-generic-table-scenario-table',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Unknown (254), ID 0 Framed-Protocol: PPP NAS-Identifier: foo.bar.org Custom-String: my-custom-string{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
 </div> 
</div> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>load generic packet dictionary</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor5"> 
   <td colspan="4">load generic packet dictionary</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>set host</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>load generic packet endpoint scenario</td> 
  </tr> 
  <tr class="slimRowColor5"> 
   <td colspan="2">load generic packet dictionary</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>set host</td> 
   <td>127.0.0.1</td> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor6"> 
   <td colspan="4">load generic packet endpoint scenario</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>set packet type</td> 
   <td colspan="3">254</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td colspan="3">load generic packet base request</td> 
  </tr> 
  <tr class="slimRowColor6"> 
   <td colspan="4">load generic packet endpoint scenario</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor7"> 
   <td colspan="4">load generic packet base request</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>set packet type</td> 
   <td colspan="3">254</td> 
...
export class GenericTableScenarioTableComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'GenericTableScenarioTableComponent';
  }
