...
@Component({
  selector: 'app-generic-table-endpoint-definition',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST_0= {{'{'}}{{'{'}}{{'{'}}Unknown (254), ID 0 NAS-Identifier: foo.bar.org{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Set Endpoint in RADIUS Fixture Table Mode</h2> Host, Port and Shared Secret are the minimum set of coordinates to set a RADIUS endpoint and can be defined as shown in the following examples.
<br>
<br>
...
export class GenericTableEndpointDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'GenericTableEndpointDefinitionComponent';
  }
