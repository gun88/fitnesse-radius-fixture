...
@Component({
  selector: 'app-generic-script-extend-dictionary',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Unknown (254), ID 0 NAS-Identifier: foo.bar.org Framed-Protocol: PPP Custom-String: my-custom-string Custom-Integer: 1234 Custom-Octets: 0x00ab00 Custom-Date: 1634311572 Custom-Ipaddr: 1.2.3.4 Custom-Ipv6addr: 2001:8d0:200:640b:0:0:0:1 Custom-Ipv6prefix: 2001:8d0:200:640b:0:0:0:0/64 Vendor-Specific: vendor ID 3000 Custom-Vendor-String: my-custom-vendor-string Vendor-Specific: vendor ID 3000 Custom-Vendor-Integer: 9234{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: RESPONSE= {{'{'}}{{'{'}}{{'{'}}Unknown (254), ID 0 NAS-Identifier: foo.bar.org Framed-Protocol: PPP Custom-String: my-custom-string Custom-Integer: 1234 Custom-Octets: 0x00ab00 Custom-Date: 1634311572 Custom-Ipaddr: 1.2.3.4 Custom-Ipv6addr: 2001:8d0:200:640b:0:0:0:1 Custom-Ipv6prefix: 2001:8d0:200:640b:0:0:0:0/64 Vendor-Specific: CustomVendor (3000) Custom-Vendor-String: my-custom-vendor-string Vendor-Specific: CustomVendor (3000) Custom-Vendor-Integer: 9234{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
 </div> 
</div> 
<h2 id="0">Extend Dictionary in RADIUS Fixture Script Mode</h2> Following examples show how to extend Dictionary in RADIUS Communication. The suggested method is 
<i>Scenario Table</i>.
<br>
<br>
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>my generic packet request with dictionary</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td colspan="2">load radius generic endpoint</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>extend dictionary</td> 
   <td><pre>
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor4"> 
   <td colspan="4">my generic packet request with dictionary</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>set packet type</td> 
   <td colspan="3">254</td> 
...
export class GenericScriptExtendDictionaryComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'GenericScriptExtendDictionaryComponent';
  }
