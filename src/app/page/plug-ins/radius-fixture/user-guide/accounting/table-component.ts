...
@Component({
  selector: 'app-accounting-table-table',
  template: `
    <article><h2 id="0">RADIUS Accounting Communication - Table Mode</h2> This mode is useful for multiple request communication.
<br>
...
export class AccountingTableTableComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingTableTableComponent';
  }
