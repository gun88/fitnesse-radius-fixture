...
@Component({
  selector: 'app-accounting-table-scenario-table',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Accounting-Request, ID 0 Acct-Session-Id: acct-001 User-Name: fooBar00 Custom-String: my-custom-string{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor9"> 
   <td colspan="4">load acct dictionary</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>set host</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>load acct endpoint scenario</td> 
  </tr> 
  <tr class="slimRowColor9"> 
   <td colspan="2">load acct dictionary</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>set host</td> 
   <td>127.0.0.1</td> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td colspan="4">load acct endpoint scenario</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Acct-Session-Id</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td colspan="3">load acct base request</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td colspan="4">load acct endpoint scenario</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor1"> 
   <td colspan="4">load acct base request</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>User-Name</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>radius acct table request _</td> 
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td colspan="2">radius acct table request</td> 
  </tr> 
  <tr class="slimRowTitle"> 
   <td>requestId</td> 
   <td>responseId?</td> 
...
export class AccountingTableScenarioTableComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingTableScenarioTableComponent';
  }
