...
@Component({
  selector: 'app-accounting-table-endpoint-definition',
  template: `
...
<h2 id="0">Set Endpoint in RADIUS Accounting Fixture Table Mode</h2> Host, Port and Shared Secret are the minimum set of coordinates to set a RADIUS endpoint and can be defined as shown in the following examples.
<br>
<br>
...
export class AccountingTableEndpointDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingTableEndpointDefinitionComponent';
  }
