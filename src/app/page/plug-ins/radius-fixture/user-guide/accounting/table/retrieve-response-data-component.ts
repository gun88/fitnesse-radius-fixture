...
@Component({
  selector: 'app-accounting-table-retrieve-response-data',
  template: `
...
<div class="collapsible closed">
 ...
 <div>
  ...
  <br>
  <br>
  <span class="meta">variable defined: RESPONSE_2= {{'{'}}{{'{'}}{{'{'}}Accounting-Response, ID 222 Proxy-State: 0x0012 Reply-Message: Accounting Done! Reply-Message: event: Start{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
 </div> 
</div> 
<h2 id="0">Get Data from RADIUS Accounting Response Table Mode</h2> Following examples show how to retrieve data from responses.
<br>
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor1"> 
   ...
   <td><pre>Accounting-Response, ID 111
Proxy-State: 0x0012
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor1"> 
   ...
   <td><pre>Accounting-Response, ID 222
Proxy-State: 0x0012
...
export class AccountingTableRetrieveResponseDataComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingTableRetrieveResponseDataComponent';
  }
