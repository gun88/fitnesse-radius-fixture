...
@Component({
  selector: 'app-accounting-table-extend-dictionary',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Accounting-Request, ID 0 Acct-Status-Type: Start Custom-String: fooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Extend Dictionary in RADIUS Accounting Fixture Table Mode</h2> Following examples show how to extend Dictionary in RADIUS Accounting Communication.
<br>
<br>
...
export class AccountingTableExtendDictionaryComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingTableExtendDictionaryComponent';
  }
