...
@Component({
  selector: 'app-accounting-script-endpoint-definition',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST_0= {{'{'}}{{'{'}}{{'{'}}Accounting-Request, ID 0 Acct-Status-Type: Start{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Set Endpoint in RADIUS Accounting Fixture Script Mode</h2> Host, Port and Shared Secret are the minimum set of coordinates to set a RADIUS endpoint and can be defined as shown in the following examples.
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td colspan="4">my radius acct endpoint</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Acct-Status-Type</td> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>request</td> 
   <td colspan="3"><pre>Accounting-Request, ID 0
...
User-Name: fooBar</pre></td> 
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="3"><pre>Accounting-Response, ID 0</pre></td> 
  </tr> 
 </tbody>
</table> 
...
export class AccountingScriptEndpointDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingScriptEndpointDefinitionComponent';
  }
