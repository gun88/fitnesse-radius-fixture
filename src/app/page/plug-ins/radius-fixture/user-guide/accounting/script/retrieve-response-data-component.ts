...
@Component({
  selector: 'app-accounting-script-retrieve-response-data',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: RESPONSE_0= {{'{'}}{{'{'}}{{'{'}}Accounting-Response, ID 111 Proxy-State: 0x0012 Reply-Message: Accounting Done!{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: RESPONSE_1= {{'{'}}{{'{'}}{{'{'}}Accounting-Response, ID 222 Proxy-State: 0x0014 Reply-Message: Accounting Done! Reply-Message: event: Start{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
 </div> 
</div> 
<h2 id="0">Get Data from RADIUS Accounting Response Script Mode</h2> Following examples show how to retrieve data from responses.
<br>
...
<br>
<br>
<h3 id="1">Single Data</h3> Retrieve single data from RADIUS Accounting Response.
<br>
<br>
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="2"><pre>Accounting-Response, ID 111
Proxy-State: 0x0012
Reply-Message: Accounting Done!</pre></td> 
  </tr> 
 </tbody>
</table> 
<br>
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="2"><pre>Accounting-Response, ID 222
Proxy-State: 0x0014
...
<br>
<h3 id="3">Multiple Data in Multiple Field</h3> When response attribute id refers to a list, values can be retrieved one by one with method 
<i>response attribute at</i>.
<br>
<br>
<table> 
 <tbody>
  ...
  <tr class="slimRowColor6"> 
   <td colspan="6">load radius acct endpoint</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>set request id</td> 
   <td colspan="5">222</td> 
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>send accounting</td> 
   <td colspan="4">Accounting-Response</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response id</td> 
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="4"><pre>Accounting-Response, ID 222
Proxy-State: 0x0014
Reply-Message: Accounting Done!
Reply-Message: event: Start</pre></td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor6"> 
   <td colspan="5">load radius acct endpoint</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>set request id</td> 
   <td colspan="4">222</td> 
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>send accounting</td> 
   <td colspan="3">Accounting-Response</td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response id</td> 
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="3"><pre>Accounting-Response, ID 222
Proxy-State: 0x0014
Reply-Message: Accounting Done!
Reply-Message: event: Start</pre></td> 
  </tr> 
...
export class AccountingScriptRetrieveResponseDataComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingScriptRetrieveResponseDataComponent';
  }
