...
@Component({
  selector: 'app-accounting-script-attributes-definition',
  template: `
...
<h2 id="0">Set Attributes in RADIUS Accounting Fixture Script Mode</h2> In script mode, attributes can be set or removed via rows. Default attributes can also be defined by header map.
<br>
<br>
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td colspan="3">my base acct request</td> 
  </tr> 
  <tr class="slimRowColor6"> 
   <td colspan="4">load radius acct endpoint</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor5"> 
   <td colspan="4">my base acct request</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>User-Name</td> 
...
export class AccountingScriptAttributesDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingScriptAttributesDefinitionComponent';
  }
