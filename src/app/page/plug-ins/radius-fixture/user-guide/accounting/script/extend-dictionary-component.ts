...
@Component({
  selector: 'app-accounting-script-extend-dictionary',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Accounting-Request, ID 0 Acct-Status-Type: Start Custom-String: my-custom-string Custom-Integer: 1234 Custom-Octets: 0x00ab00 Custom-Date: 1634311572 Custom-Ipaddr: 1.2.3.4 Custom-Ipv6addr: 2001:8d0:200:640b:0:0:0:1 Custom-Ipv6prefix: 2001:8d0:200:640b:0:0:0:0/64 Vendor-Specific: CustomVendor (3000) Custom-Vendor-String: my-custom-vendor-string Vendor-Specific: CustomVendor (3000) Custom-Vendor-Integer: 9234{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Extend Dictionary in RADIUS Accounting Fixture Script Mode</h2> Following examples show how to extend Dictionary in RADIUS Accounting Communication. The suggested method is 
<i>Scenario Table</i>.
<br>
<br>
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td>my acct request with dictionary</td> 
  </tr> 
  <tr class="slimRowColor6"> 
   <td colspan="2">load radius acct endpoint</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>extend dictionary</td> 
   <td><pre>
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor8"> 
   <td colspan="4">my acct request with dictionary</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Acct-Status-Type</td> 
...
export class AccountingScriptExtendDictionaryComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AccountingScriptExtendDictionaryComponent';
  }
