...
@Component({
  selector: 'app-authentication-script-endpoint-definition',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: PPP{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Set Endpoint in RADIUS Authentication Fixture Script Mode</h2> Host, Port and Shared Secret are the minimum set of coordinates to set a RADIUS endpoint and can be defined as shown in the following examples.
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor3"> 
   <td colspan="4">my radius auth endpoint</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>User-Name</td> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>request</td> 
   <td colspan="3"><pre>Access-Request, ID 0
User-Name: anon
Framed-Protocol: PPP</pre></td> 
  </tr> 
  <tr class="slimRowColor0"> 
   <td>check</td> 
   <td>response</td> 
   <td colspan="3"><pre>Access-Accept, ID 0</pre></td> 
  </tr> 
 </tbody>
</table> 
...
export class AuthenticationScriptEndpointDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationScriptEndpointDefinitionComponent';
  }
