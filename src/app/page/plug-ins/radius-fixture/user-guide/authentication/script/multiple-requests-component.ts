...
@Component({
  selector: 'app-authentication-script-multiple-requests',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST_0= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: PPP{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_1= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_2= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: SLIP{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Multiple Requests in RADIUS Authentication Fixture Script Mode</h2> Multiple request can be sent in script mode paying attention to update/remove attributes.
<br>
<br>
<table> 
 <tbody>
...
<br>
<h3 id="2">Multiple Authentication Message</h3> Following example shows multiple RADIUS Authentication communication. However, for multiple communication, table mode is suggested.
<br>
<br>
<table> 
 <tbody>
  ...
  <tr class="slimRowColor8"> 
   <td>note</td> 
   <td colspan="3">sending PPP framed protocol</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Framed-Protocol</td> 
  ...
  <tr class="slimRowColor0"> 
   ...
   <td>Reply-Message</td> 
   <td>Framed-Protocol: PPP</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>note</td> 
   <td colspan="3">sending SLIP framed protocol</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Framed-Protocol</td> 
  ...
  <tr class="slimRowColor0"> 
   ...
   <td>response attribute</td> 
   <td>Reply-Message</td> 
   <td>Framed-Protocol: SLIP</td> 
  </tr> 
  <tr class="slimRowColor8"> 
   <td>note</td> 
   <td colspan="3">sending ARAP framed protocol</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>Framed-Protocol</td> 
  ...
  <tr class="slimRowColor0"> 
   ...
   <td>response attribute</td> 
   <td>Reply-Message</td> 
   <td>Framed-Protocol: ARAP</td> 
  </tr> 
 </tbody>
</table></article>`,
  styles: ['']
})
export class AuthenticationScriptMultipleRequestsComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationScriptMultipleRequestsComponent';
  }
