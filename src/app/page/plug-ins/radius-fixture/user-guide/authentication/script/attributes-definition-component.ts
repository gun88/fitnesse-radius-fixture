...
@Component({
  selector: 'app-authentication-script-attributes-definition',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST_1= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: PPP{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_2= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: PPP Class: A:fooBar Class: B:zooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_3= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Framed-Protocol: SLIP{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_4= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_5= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 Framed-Protocol: PPP User-Name: anon{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Set Attributes in RADIUS Authentication Fixture Script Mode</h2> In script mode, attributes can be set or removed via rows. Default attributes can also be defined by header map.
<br>
<br>
...
<table> 
 <tbody>
  <tr class="slimRowTitle"> 
   <td>scenario</td> 
   <td colspan="3">my base auth request</td> 
  </tr> 
  <tr class="slimRowColor9"> 
   <td colspan="4">load radius auth endpoint</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor8"> 
   <td colspan="4">my base auth request</td> 
  </tr> 
  <tr class="slimRowColor3"> 
   <td>set request attribute</td> 
   <td>User-Name</td> 
...
export class AuthenticationScriptAttributesDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationScriptAttributesDefinitionComponent';
  }
