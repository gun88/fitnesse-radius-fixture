...
@Component({
  selector: 'app-authentication-table-extend-dictionary',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Custom-String: fooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Extend Dictionary in RADIUS Authentication Fixture Table Mode</h2> Following examples show how to extend Dictionary in RADIUS Authentication Communication.
<br>
<br>
...
export class AuthenticationTableExtendDictionaryComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationTableExtendDictionaryComponent';
  }
