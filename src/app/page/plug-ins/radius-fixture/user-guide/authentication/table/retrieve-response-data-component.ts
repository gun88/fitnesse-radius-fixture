...
@Component({
  selector: 'app-authentication-table-retrieve-response-data',
  template: `
...
<div class="collapsible closed">
 ...
 <div>
  ...
  <br>
  <br>
  <span class="meta">variable defined: RESPONSE_2= {{'{'}}{{'{'}}{{'{'}}Access-Accept, ID 222 Proxy-State: 0x0012 Reply-Message: user: 'anon' Reply-Message: role: 'anon'{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
 </div> 
</div> 
<h2 id="0">Get Data from RADIUS Authentication Response Table Mode</h2> Following examples show how to retrieve data from responses.
<br>
...
export class AuthenticationTableRetrieveResponseDataComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationTableRetrieveResponseDataComponent';
  }
