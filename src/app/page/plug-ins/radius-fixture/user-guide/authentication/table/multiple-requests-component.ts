...
@Component({
  selector: 'app-authentication-table-multiple-requests',
  template: `
...
<div class="collapsible closed">
 ...
 <p class="title">definitions</p> 
 <div>
  <span class="meta">variable defined: REQUEST_0= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Filter-Id: fooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_1= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_2= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Filter-Id: zooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_3= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Class: A:fooBar Class: B:zooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Multiple Requests in RADIUS Authentication Fixture Table Mode</h2> Multiple request can be easily sent in table mode.
<br>
<br>
<table> 
 <tbody>
...
export class AuthenticationTableMultipleRequestsComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationTableMultipleRequestsComponent';
  }
