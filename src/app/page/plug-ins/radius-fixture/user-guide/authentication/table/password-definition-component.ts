...
@Component({
  selector: 'app-authentication-table-password-definition',
  template: `
...
<table> 
 <tbody>
  ...
  <tr class="slimRowTitle"> 
   <td>packet type</td> 
   <td>User-Name</td> 
   <td colspan="2">packet type name?</td> 
  </tr> 
...
<table> 
 <tbody>
  ...
  <tr class="slimRowColor1"> 
   <td>Authentication</td> 
   <td>0x000102030405060708900a0b0c0d0e0f</td> 
   <td>user001</td> 
...
export class AuthenticationTablePasswordDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationTablePasswordDefinitionComponent';
  }
