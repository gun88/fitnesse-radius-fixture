...
@Component({
  selector: 'app-authentication-table-attributes-definition',
  template: `
...
<div class="collapsible closed">
 ...
 <div>
  ...
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_2= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Class: A:fooBar Class: B:zooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_3= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Filter-Id: fooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_4= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Filter-Id: zooBar{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_5= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
  <span class="meta">variable defined: REQUEST_6= {{'{'}}{{'{'}}{{'{'}}Access-Request, ID 0 User-Name: anon Filter-Id: null{{'}'}}{{'}'}}{{'}'}} </span> 
  <br>
  <br>
...
<h2 id="0">Set Attributes in RADIUS Authentication Fixture Table Mode</h2> In table mode, attributes can be set or removed via columns. Default attributes can also be defined by header map.
<br>
<br>
...
export class AuthenticationTableAttributesDefinitionComponent extends BaseTestPage {
  ...
  getPageName() {
    return 'AuthenticationTableAttributesDefinitionComponent';
  }
